...
public class Fragment_Items_Two  extends Fragment implements Serializable {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        shopRcyclerView.setAdapter(itemshopAdapter);
        shopRcyclerView.addOnItemTouchListener(new RecyclerTouchListener(mContext, shopRcyclerView, new Fragment_Items_Two.ClickListener() {
            @Override
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println("hi Fragment Two"+shippingorder);
